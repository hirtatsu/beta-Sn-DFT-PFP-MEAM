"""8-method comparison: adds Ko 2018 MEAM (NIST IPR id 2018--Ko-W-S--Sn) to the 7-face chart.
Based on 29_final_comparison_7faces.py with FIG path corrected for current host.
"""
import os
import numpy as np
...
DATA = {
    ...
    'MEAM/Ko 2018':      [345.4, 367.2, 494.3, 485.3, 472.8, 433.2, 370.1],
}
EXP_AVG = 670
...
ax.set_title('β-Sn surface energies — 7 faces × 8 methods (with Ko 2018 MEAM added)')
ax.set_ylim(0, 1750)
...
plt.tight_layout()
outp_png = os.path.join(FIG, 'surface_energy_comparison_8methods.png')
outp_tif = os.path.join(FIG, 'surface_energy_comparison_8methods.tif')
